...
{
    [MenuItem("Tools/Wagenheimer/Tk2d Porter/Auto-detect Conversion (Selection)", false, 100)]
    ...
    [MenuItem("Tools/Wagenheimer/Tk2d Porter/Auto-detect Conversion (Selection)", true)]
